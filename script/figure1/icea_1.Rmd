...
### 2.2.3 Comparison in the ability to indetify enhancers in distance ranges
...
names(dist.lab) = unique(Enh.Prom.pairs.sig.summary$DistanceBin)
...
## 2.3 Gene level enhancer indetificantion increased with “ICEA”
...
## 2.4 Example of situation where only interaction-based annotation identify elements 
